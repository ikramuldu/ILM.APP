...
public class TopicFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView.LayoutManager layoutManager=new MyLayoutManager(activity);
        RecyclerView recyclerView=view.findViewById(R.id.main_list);
        activity.setSupportActionBar(view.findViewById(R.id.toolbar));
        recyclerView.setLayoutManager(layoutManager);
        recyclerView.setAdapter(new IndexAdapter(activity, layoutManager));
        activity.setTitle(R.string.menu_quran_index);
        return view;
    }
}
